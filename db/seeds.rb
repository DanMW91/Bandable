...
bachelor = Bangsd.create!({ spotify_embed_url: 'https://open.spotify.com/embed/artist/7B1OPA8Ttxfv3XBDCkw24E', name: 'Bachelor', current_member_count: 2, location: 'Los Angeles, USA', genre: "Alternative", bio: "Last year, the minds behind Jay Som (Melina Duterte) and Palehound (Ellen Kempner) rented a house in the California canyons. Topanga Canyon, to be precise—a winding, weaving little hippie hideout with a long creative history."})
