...
black_sabbath.photo.attach(io: black_sabbath_photo, content_type: 'image/png')
...
crumb.photo.attach(io: crumb_photo, content_type: 'image/png')
...
bachelor.photo.attach(io: bachelor_photo, content_type: 'image/png')
...
drug_store_romeos.photo.attach(io: drug_store_romeos_photo, content_type: 'image/png')
...
chai.photo.attach(io: chai_photo, content_type: 'image/png')
...
babygirl.photo.attach(io: baby_girl_photo, content_type: 'image/png')
...
just_wondering.photo.attach(io: just_wondering_photo, content_type: 'image/png')
#black sabbath
...
ozzy.photo.attach(io: ozzy_photo, content_type: 'image/png')
...
bill.photo.attach(io: bill_photo, content_type: 'image/png')
...
tony.photo.attach(io: tony_photo, content_type: 'image/png')
...
lila.photo.attach(io: lila_photo, content_type: 'image/png')
...
jesse.photo.attach(io: jesse_photo, content_type: 'image/png')
...
bri.photo.attach(io: bri_photo, content_type: 'image/png')
...
jonathan.photo.attach(io: jonathan_photo, content_type: 'image/png')
...
melina.photo.attach(io: melina_photo, content_type: 'image/png')
...
ellen.photo.attach(io: ellen_photo, content_type: 'image/png')
...
charlie.photo.attach(io: charlie_photo, content_type: 'image/png')
...
johnny.photo.attach(io: johnny_photo, content_type: 'image/png')
...
sarah.photo.attach(io: sarah_photo, content_type: 'image/png')
...
mana.photo.attach(io: mana_photo, content_type: 'image/png')
...
kana.photo.attach(io: kana_photo, content_type: 'image/png')
...
yuna.photo.attach(io: yuna_photo, content_type: 'image/png')
...
yuuki.photo.attach(io: yuuki_photo, content_type: 'image/png')
...
kiki.photo.attach(io: kiki_photo, content_type: 'image/png')
...
cameron.photo.attach(io: cameron_photo, content_type: 'image/png')
...
wale.photo.attach(io: wale_photo, content_type: 'image/png')
...
jack.photo.attach(io: jack_photo, content_type: 'image/png')
...
adam.photo.attach(io: adam_photo, content_type: 'image/png')
