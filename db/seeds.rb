...
black_sabbath = Band.create!({ spotify_embed_url: 'https://open.spotify.com/embed/artist/5M52tdBnJaKSvOpJGz8mfZ', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Sabs.jpg/2560px-Sabs.jpg', name: 'Black Sabbath', current_member_count: 4, location: 'London, England', genre: "Heavy Metal", bio: "Black Sabbath is credited with creating heavy metal. The success of their first two albums - Black Sabbath and Paranoid - marked a paradigm shift in the world of rock. Not until Black Sabbath upended the music scene did the term “heavy metal” enter the popular vocabulary to describe the denser, more thunderous offshoot of rock over which they presided."})
...
bill = User.create!({ avatar_url: 'https://www.drummerworld.com/pics/drumpics34/billward5612.jpg', email: 'bill@bill.com', password: '123123', first_name: 'Bill', last_name: 'Ward', location: 'London', genre: 'Heavy Metal', bio: 'Drummer extraordinaire for Black Sabbath'})
